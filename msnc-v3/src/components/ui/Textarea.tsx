...
>(({ className, ...props }, ref) => {
  return (
    <textarea
      className={cn(
        "flex min-h-[160px] w-full rounded-[2rem] border-2 border-slate-100 bg-white px-6 py-5 text-base font-medium text-primary shadow-sm transition-all duration-300",

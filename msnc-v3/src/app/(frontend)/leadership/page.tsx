...
// --- 1. CONFIG & SEO ---
const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://msnc.ca";
      ...
      <div className="w-full px-4 md:px-8 lg:px-12 relative z-10 mx-auto max-w-[1500px]">
        ...
        <section className="py-24">
          <div className="bg-[#FAFAFA] border-2 border-slate-900 rounded-[3.5rem] p-12 md:p-20 text-center relative overflow-hidden">
             ...
             <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                <Link href="/contact" className="h-14 px-10 bg-[#002147] text-white rounded-full flex items-center justify-center gap-3 font-black uppercase text-[11px] tracking-widest hover:bg-blue-700 transition-all">
        ...
        <footer className="mt-12 flex flex-col md:flex-row items-center justify-between border-t border-slate-200 pt-10 gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 uppercase tracking-widest">MSNC Official Repository_2024</span>
          </div>

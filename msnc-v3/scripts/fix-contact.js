...
export default async function ContactPage({ params }: Props) {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      />
      <section className="section py-16 md:py-24 border-t border-border" aria-label="Contact section">
        <div className="container-editorial">
          <div className="grid lg:grid-cols-12 gap-16 lg:gap-24 items-start w-full">
            <div className="lg:col-span-7">
              <ContactClient />
            </div>
            <div id="contact-details" className="lg:col-span-5 lg:sticky lg:top-32 space-y-12">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <a href={\`mailto:\${t('details.email.value')}\`} className="text-xl text-primary transition-colors hover:text-secondary">
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <a href={\`tel:\${t('details.phone.value')}\`} className="text-xl text-primary transition-colors hover:text-secondary">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <address className="not-italic text-xl text-primary leading-relaxed">
                      {t('details.address.line1')}<br />
                      {t('details.address.line2')}<br />
...
fs.writeFileSync('msnc-v3/src/app/[locale]/(frontend)/contact/page.tsx', content, 'utf8');
